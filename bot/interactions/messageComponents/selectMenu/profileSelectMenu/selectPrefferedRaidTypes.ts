import {
  ...
  export const profilePrefferredRaidTypesId = "select_preferred_raid_types";
  
  export const profilePrefferredRaidTypesSelect = async (
    ...
    const selectedPreferredRaidTypes = data.values;
      ...
      (await updateUserProfile(
        {
          ...
          updates: {
            ...
            preferredRunTypes: selectedPreferredRaidTypes || [],
          },
        },
        { documentClient }
      ));
